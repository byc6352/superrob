...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="1.50";//插件版本号
	public static final String PLUGIN_NAME="superrob.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.superrob";//插件名字；
